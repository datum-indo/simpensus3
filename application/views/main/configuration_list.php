...
<style>
	textarea { resize: vertical; }
			...
			<li class="treeview active">
              ...
              <ul class="treeview-menu">
				<li><a href="<?php echo site_url('setting/account'); ?>"><i class="fa fa-user"></i>Account</a></li>
			<?php if($id_user == '201600000') { ?>
				          <li class="active"><a href="<?php echo site_url('setting/configuration'); ?>"><i class="fa fa-gear"></i>Configuration</a></li>
                <?php } ?>  
              </ul>
            </li>
			<?php } ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Configuration
            <small>Simpensus Configuration</small>
          </h1>
          <ol class="breadcrumb">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                  <table id="Tbl_Setting" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Alamat Kantor</th>
...
<?php
	include('configuration_js.php');
	include('configuration_form.php');
	include('configuration_view.php');
	include('footer.php');
?>	