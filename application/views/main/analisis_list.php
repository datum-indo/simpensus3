	...
	textarea { resize: vertical; }
			...
			<li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="<?php echo site_url('analisis'); ?>"><i class="fa fa-circle-o text-green"></i> <span>Analisis</span></a></li>
			  </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Analisis
            <small>Data Analisis Bantuan Hukum</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <?php if($id_role == '1' || $id_role == '2' || $id_role == '3' || $id_role == '4') { ?>
					<button id="view_form_add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> Add Analisis</button>
				  <?php } ?>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="Tbl_Analisis" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
...
<?php
	include('analisis_js.php');
?>	  
<?php
	include('analisis_form.php');
?> 
<?php
	include('analisis_view.php');
?>  
<?php
	include('footer.php');
?>	