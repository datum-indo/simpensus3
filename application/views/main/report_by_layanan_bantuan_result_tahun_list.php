                              ...
                              <table class="table table-bordered">
                                  <thead>
                                      <tr>
                                          ...
                                          <th class="col-md-3">Diterima</th>
                                          <th class="col-md-3">Ditolak</th>
                                          <th class="col-md-3">Total</th>
                                      </tr>
                                  </thead>
                                  <tbody>
                                      <?php
                                          $diterima = 0; $ditolak = 0; $total = 0;
                                          foreach($report->result_array() as $row)
                                          {
                                            echo '<tr>';
                                            echo '<td class="col-md-3">'.$row['bulan'].'</td><td class="col-md-3 tengah">'.$row['diterima'].'</td><td class="col-md-3 tengah">'.$row['ditolak'].'</td><td class="col-md-3 tengah">'.$row['total'].'</td>';
                                            echo '</tr>';
                                  ...
                                  <tfoot>
                                      <tr>
                                          <th class="col-md-3">Total</th>
                                          <th class="col-md-3"><?php echo $diterima; ?></th>
                                          <th class="col-md-3"><?php echo $ditolak; ?></th>
                                          <th class="col-md-3"><?php echo $total; ?></th>
                                      </tr>
                                  </tfoot>  
                              </table>
                            </div>
