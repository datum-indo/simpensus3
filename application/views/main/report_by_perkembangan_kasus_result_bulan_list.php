                    ...
                    <div class="box-body" id="print_area">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h4><strong>Periode <?php echo $month; ?> Tahun <?php echo $tahun; ?></strong></h4>
                            </div>
                        </div>    
                        <div class="row">
                            &nbsp;
                              ...
                              <table class="table table-bordered">
                                  <thead>
                                      <tr>
                                          ...
                                          <th class="">Tanggal</th>
                                          <th class="">Penerima Bantuan</th>
                                          <th class="">Bentuk Layanan</th>
                                          <th class="">Pembela Umum</th>
                                          <th class="">Tanggal Progress</th>
                                          <th class="">Status</th>
                                          <th class="">Tahap Progress Akhir</th>
                                          <th class="">Hasil Keputusan</th>
                                      </tr>
                                  </thead>
                                  <tbody>
                                      <?php
                                          $selesai = 0; $belum = 0; $gugur = 0; $na = 0; $no = 1;
                                          foreach($report->result_array() as $row)
                                          {
                                            echo '<tr>';
                                            echo '<td class="kanan">'.$no++.'</td>'; 
                                            echo '<td class="">'.$row['no_reg'].'</td>'; 
                                            echo '<td class="">'.$row['tgl_reg'].'</td>'; 
                                            echo '<td class="">'.$row['nm_penerima'].'</td>'; 
                                            echo '<td class="">'.$row['bentuk_layanan'].'</td>';
                                            echo '<td class="">'.$row['nm_pembela'].'</td>';
                                            echo '<td class="">'.$row['tgl_progress'].'</td>';
                                            echo '<td class="">'.$row['status_progress'].'</td>';
                                            echo '<td class="">'.$row['tahap_progress'].'</td>';
                                            echo '<td class="">'.$row['hasil_keputusan'].'</td>';
                                            echo '</tr>';
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><strong>Selesai = <?php echo $selesai; ?></strong></p>
                                <p><strong>Belum Selesai = <?php echo $belum; ?></strong></p>
                                <p><strong>Gugur = <?php echo $gugur; ?></strong></p>
								<p><strong>N/A = <?php echo $na; ?></strong></p>
                                <p><strong>Total = <?php echo $no-1; ?></strong></p>
                            </div>
                        </div>  
                    </div>
