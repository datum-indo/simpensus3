	...
	textarea { resize: vertical; }
			...
			<li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="<?php echo site_url('tabel/kategori_pelaku'); ?>"><i class="fa fa-circle-o"></i>Kategori Pelaku</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Kategori Pelaku
            <small>Tabel Data Kategori Pelaku</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
            <li>Tabel</li>
            <li class="active"><a href="#">Kategori Pelaku</a></li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<button id="view_form_add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> Add Kategori Pelaku</button>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="Tbl_Kategori_pelaku" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Kategori Pelaku</th>
						<th>Nomor Urut</th>
...
<?php
	include('kategori_pelaku_js.php');
	include('kategori_pelaku_form.php');
	//include('kategori_pelaku_view.php');
	include('footer.php');
?>	