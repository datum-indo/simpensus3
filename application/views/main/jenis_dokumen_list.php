	...
	textarea { resize: vertical; }
			...
			<li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="<?php echo site_url('tabel/jenis_dokumen'); ?>"><i class="fa fa-circle-o"></i>Jenis Dokumen</a></li>
              </ul>
            </li>
			<?php } ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Jenis Dokumen
            <small>Tabel Data Jenis Dokumen</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<button id="view_form_add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> Add Jenis Dokumen</button>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="Tbl_Jenis_dokumen" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Jenis Dokumen</th>
...
<?php
	include('jenis_dokumen_js.php');
	include('jenis_dokumen_form.php');
	//include('jenis_dokumen_view.php');
	include('footer.php');
?>	