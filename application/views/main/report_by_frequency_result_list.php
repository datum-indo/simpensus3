            ...
            <div class="col-md-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <div class="row">
                        <?php echo form_open('report/frequency_tabulation', 'id="thisform" class="" enctype="multipart/form-data"'); ?>
                        <?php echo form_hidden('report_type', ''); ?>
							...
							<div class="col-md-1">
							   <div class="form-group">
									...
									<?php echo form_dropdown('freq_periode', $freq_periode, '', 'id="freq_periode" class="form-control chosen-select-deselect" data-placeholder="Periode"'); ?>
									<span class="help-block"></span>
							   </div>
							</div>
							<div class="col-md-1">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    {
                                                        echo '<tr>';
                                                        echo '<td class="col-md-8">'.$row['description'].'</td>';
                                                        echo '<td class="col-md-2 tengah">'.$row['jumlah'].'</td>';
                                                        echo '<td class="col-md-2 tengah">'.$row['freq'].'</td>';
                                                        echo '</tr>';
                                                    }
                                                ?> 
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="col-md-2"><?php echo ROUND($freq); ?></th>
                                                </tr>
                                            </tfoot>  
                                        </table>
                                    <?php } else { ?>
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                <td class="col-md-8"><?php echo $judul; ?></td>
...
<?php
	include('report_by_frequency_js.php');
    include('footer.php');
?>	