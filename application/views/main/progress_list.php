	...
	textarea { resize: vertical; }
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="<?php echo site_url('progress'); ?>"><i class="fa fa-circle-o text-yellow"></i> <span>Progress</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Progress
            <small>Data Proses Perkembangan Bantuan Hukum</small>
          </h1>
          <ol class="breadcrumb">
              ...
              <div class="box">
                <div class="box-header">
                  <?php if($id_role == '1' || $id_role == '2' || $id_role == '3' || $id_role == '4' || $id_role == '5' ) { ?>
					<button id="view_form_add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> Add Progress</button>
				  <?php } ?>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="Tbl_Progress" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
					    <th>#</th>
...
<?php
	include('progress_js.php');
	include('progress_form.php');
	include('progress_upload_form.php');
	include('progress_view.php');
	include('footer.php');
?>	