...
<style>
	textarea { resize: vertical; }
			...
			<li class="treeview  active">
              ...
              <ul class="treeview-menu">
				<li ><a href="<?php echo site_url('tabel/pekerjaan'); ?>"><i class="fa fa-circle-o"></i>Pekerjaan</a></li>
				<li class="active"><a href="<?php echo site_url('tabel/agama'); ?>"><i class="fa fa-circle-o"></i>Agama</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Agama
            <small>Tabel Data Agama</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
            <li>Tabel</li>
            <li class="active"><a href="#">Agama</a></li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<button id="view_form_add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> Add Agama</button>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="Tbl_Agama" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Agama</th>
...
<?php
	include('agama_js.php');
	include('agama_form.php');
	//include('agama_view.php');
	include('footer.php');
?>	