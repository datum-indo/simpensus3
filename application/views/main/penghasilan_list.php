	...
	textarea { resize: vertical; }
			...
			<li class="treeview  active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="<?php echo site_url('tabel/penghasilan'); ?>"><i class="fa fa-circle-o"></i>Penghasilan</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Penghasilan
            <small>Tabel Data Penghasilan</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
            <li>Tabel</li>
            <li class="active"><a href="#">Penghasilan</a></li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<button id="view_form_add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> Add Penghasilan</button>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="Tbl_Penghasilan" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
...
<?php
	include('penghasilan_js.php');
	include('penghasilan_form.php');
	include('footer.php');
?>	