...
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Report Data Layanan Bantuan Yang Belum Dianalisis 
            <small>Berdasarkan Periode Tahun</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <div class="row">
                            <?php echo form_open('report/data_belum_dianalisis', 'id="thisform" class="" enctype="multipart/form-data"'); ?>
                    ...
                    <div class="box-body" id="print_area">
                        <div class="row">
                            <div class="col-md-12">
                                <h4><strong>Data Layanan Bantuan Yang Belum Dianalisis</strong></h4>
                              ...
                              <table class="table table-bordered">
                                  <thead>
                                      <tr>
                                          ...
                                          <th class="">Jenis Masalah Hukum</th>
                                          <th class="">Posisi Hukum</th>
                                          <th class="">Bentuk Layanan</th>
                                          <th class="">Pembela Umum</th>
                                          <th class="">Asisten PU</th>
                                      </tr>
                                  </thead>
                                  <tbody>
                                      <?php
										  ...
										  if($report->num_rows() > 0 )
										  {
											foreach($report->result_array() as $row)
                                            {
												...
												echo '<td class="">'.$row['jenis_kasus'].'</td>';
												echo '<td class="">'.$row['posisi_hukum'].'</td>';
												echo '<td class="">'.$row['jenis_tindakan'].'</td>';
												echo '<td class="">'.$row['nm_analis'].'</td>';
												echo '<td class="">'.$row['nm_asisten'].'</td>';
												echo '</tr>';
											}  
										  }
										  else
						...
						<div class="row">
                            <div class="col-md-12">
                                <p><strong>Jumlah yang belum dianalisis : <?php echo $no-1; ?></strong></p>
                            </div>
                        </div>    
