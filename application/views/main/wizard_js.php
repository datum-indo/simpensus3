<script type="text/javascript">
	// function getValue(){
	//             var val = $('#id_pekerjaan').combotree('getValue');
	//             alert(val);
	//         }
	//         function setValue(){
	// 			$('#id_pekerjaan').combotree().click()		
	// 			$('#id_pekerjaan').combotree('setValue', "01010402000010");
	//         }
	//         function disable(){
	//             $('#id_pekerjaan').combotree('disable');
	//         }
	//         function enable(){
	//             $('#id_pekerjaan').combotree('enable');
	// 		}
	...
	$(document).ready(function() {
		...
		$("select").change(function() {
			$(this).parent().removeClass('has-error');
			$(this).parent().removeClass('validatebox-invalid');
			//$(this).next().empty();
		});
		...
		$('#id_count_unit').val('').trigger('chosen:updated');
		$('#id_agama').val('').trigger('chosen:updated');
		$('[name="agama_desc"]').prop({
			disabled: true
		});
		...
		$('#id_pendidikan').val('').trigger('chosen:updated');
		$('[name="pendidikan_desc"]').prop({
			disabled: true
		});

		$('[name="id_pendidikan"]').change(function() {
			if ($(this).val() == '') {
				$('[name="pendidikan_desc"]').val('');
				$('[name="pendidikan_desc"]').prop({
					disabled: true
				});
			} else if ($(this).val() == '9') {
		...
		// $('#id_pekerjaan').val('').trigger('chosen:updated');
		$('[name="pekerjaan_desc"]').val('');
		$('[name="pekerjaan_desc"]').prop({
			disabled: true
		});
		$('#id_pekerjaan').combotree({
			'onChange': function() {
				console.log($(this).combotree('getValue'))
				if ($(this).combotree('getValue') == '') {
					$('[name="pekerjaan_desc"]').val('');
					$('[name="pekerjaan_desc"]').prop({
						disabled: true
					});
				} else if ($(this).combotree('getValue') === '90000000000010') {
					$('[name="pekerjaan_desc"]').val('');
					$('[name="pekerjaan_desc"]').prop({
						disabled: false
					});
		...
		$('#id_pekerjaansi').combotree('disable')
		$('[name="pekerjaansi_desc"]').val('');
		$('[name="pekerjaansi_desc"]').prop({
			disabled: true
		});
		$('input[name=pekerjaansi]').change(function() {
			if ($(this).val() == 'Tidak') {
				...
				$('input[name="pekerjaansi"][value="Ya"]').removeAttr('checked');
				$('#id_pekerjaansi').combotree('disable')
				$('#id_pekerjaansi').combotree('setValue', "")
				$('[name="pekerjaansi_desc"]').val('');
				$('[name="pekerjaansi_desc"]').prop({
					disabled: true
				});
				...
				$('#id_pekerjaansi').combotree('enable')
			}
		});


		$('#id_pekerjaansi').combotree({
			'onChange': function() {
				console.log($(this).combotree('getValue'))
				if ($(this).combotree('getValue') == '') {
					$('[name="pekerjaansi_desc"]').val('');
		...
		$('#id_count_unitb').val('').trigger('chosen:updated');
		$('#id_agamab').val('').trigger('chosen:updated');
		$('[name="agama_descb"]').prop({
			disabled: true
		});
		...
		$('#id_pendidikanb').val('').trigger('chosen:updated');
		$('[name="pendidikan_descb"]').prop({
			disabled: true
		});

		$('[name="id_pendidikanb"]').change(function() {
			if ($(this).val() == '') {
				$('[name="pendidikan_descb"]').val('');
				$('[name="pendidikan_descb"]').prop({
					disabled: true
				});
			} else if ($(this).val() == '9') {
		...
		// $('#id_pekerjaanb').val('').trigger('chosen:updated');
		$('[name="pekerjaan_descb"]').val('');
		$('[name="pekerjaan_descb"]').prop({
			disabled: true
		});
		$('#id_pekerjaanb').combotree({
			'onChange': function() {
				if ($(this).combotree('getValue') == '') {
					$('[name="pekerjaan_descb"]').val('');
					$('[name="pekerjaan_descb"]').prop({
		...
		$('#id_pekerjaansib').combotree('disable')
		$('[name="pekerjaansi_descb"]').val('');
		$('[name="pekerjaansi_descb"]').prop({
			disabled: true
		});
		$('input[name=pekerjaansib]').change(function() {
			if ($(this).val() == 'Tidak') {
				...
				$('input[name="pekerjaansib"][value="Ya"]').removeAttr('checked');
				$('#id_pekerjaansib').combotree('disable')
				$('#id_pekerjaansib').combotree('setValue', "")("chosen:updated");
				$('[name="pekerjaansi_descb"]').val('');
				$('[name="pekerjaansi_descb"]').prop({
					disabled: true
				});
				...
				$('#id_pekerjaansib').combotree('enable')
			}
		});

		$('#id_pekerjaansib').combotree({
			'onChange': function() {
				if ($(this).combotree('getValue') == '') {
					$('[name="pekerjaansi_descb"]').val('');
					$('[name="pekerjaansi_descb"]').prop({
		...
		$('[name="nm_rekomendasi"]').prop({
			disabled: true
		});
		$('[name="alm_rekomendasi"]').prop({
			disabled: true
		});
		$('[name="pekerjaan_rekomendasi"]').prop({
			disabled: true
		});
	...
	function add() {
		...
		$.ajax({
			...
			success: function(response) {
				...
				$('[name="id_count_unit"]').val('').trigger("chosen:updated");
				...
				$('#id_pekerjaan').combotree('setValue', '').trigger("chosen:updated");
				$('[name="pekerjaan_desc"]').val('');
				$('[name="pekerjaan_desc"]').prop({
					disabled: true
				});
				...
				$('input[name="pekerjaansi"][value="Ya"]').removeAttr('checked');
				$('#id_pekerjaansi').combotree('disable');
				$('#id_pekerjaansi').combotree('setValue', '').trigger("chosen:updated");
				...
				*/
				...
				$('[name="id_count_unitb"]').val('').trigger("chosen:updated");
				$('[name="agama_descb"]').val('');
				$('[name="agama_descb"]').prop({
					disabled: true
				});
				...
				$('#id_pekerjaanb').combotree('setValue', '').trigger("chosen:updated");
				$('[name="pekerjaan_descb"]').val('');
				$('[name="pekerjaan_descb"]').prop({
					disabled: true
				});
				...
				$('input[name="pekerjaansib"][value="Ya"]').removeAttr('checked');
				$('#id_pekerjaansib').combotree('disable');
				$('#id_pekerjaansib').combotree('setValue', '').trigger("chosen:updated");
				$('[name="pekerjaansi_descb"]').val('');
				$('[name="pekerjaansi_descb"]').prop({
					disabled: true
				});
	...
	function next1() {
		...
		var formData = {
			...
			pendidikan_desc: $('[name="pendidikan_desc"]').val(),
			id_agama: $('[name="id_agama"]').val(),
			id_count_unit: $('[name="id_count_unit"]').val(),
	...
	function next2() {
		...
		var formData = {
			validate: '2',
			id_pekerjaan: $('#id_pekerjaan').combotree('getValue'),
			...
			id_pekerjaansi: $('#id_pekerjaansi').combotree('getValue'),
		...
		$.ajax({
			...
			dataType: "JSON",
			success: function(data) {
				var specialCase = ["id_pekerjaan", "id_pekerjaansi", "id_pekerjaanb", "id_pekerjaansib"]
				...
				if (data.status) //if success close modal and reload ajax table
				{
					...
					for (var i = 0; i < data.inputerror.length; i++) {
						if (specialCase.find(function(res) {
								return res === data.inputerror[i]
							})) {
							$('[name="' + data.inputerror[i] + '"]').parent().addClass('validatebox-invalid');
	...
	function next3() {
		$('.form-group').removeClass('has-error'); // clear error class
		$('.form-group').removeClass('validatebox-invalid');
		$('.help-block').empty(); // clear error string
	...
	function next1b() {
		$('.form-group').removeClass('has-error'); // clear error class
		$('.form-group').removeClass('validatebox-invalid'); // clear error class
		$('.help-block').empty(); // clear error string
		...
		var formData = {
			...
			pendidikan_descb: $('[name="pendidikan_descb"]').val(),
			id_agamab: $('[name="id_agamab"]').val(),
			id_count_unitb: $('[name="id_count_unitb"]').val(),
	...
	function next2b() {
		...
		var formData = {
			validate: '2b',
			id_pekerjaanb: $('#id_pekerjaanb').combotree('getValue'),
			...
			id_pekerjaansib: $('#id_pekerjaansib').combotree('getValue'),
	...
	function edit(id_permohonan) {
		...
		$.ajax({
			...
			success: function(response) {
				...
				if (pemohon.id_pendidikan == '9') {
					$('[name="pendidikan_desc"]').val(pemohon.pendidikan_desc);
					$('[name="pendidikan_desc"]').prop({
						disabled: false
					});
				} else {
				...
				$('[name="id_count_unit"]').val(pemohon.count_unit).trigger("chosen:updated");
				...
				$('#id_pekerjaan').combotree('setValue', pemohon.id_pekerjaan).trigger("chosen:updated");
				if (pemohon.id_pekerjaan == '90000000000010') {
				...
				if (pemohon.pekerjaansi == 'Tidak') {
					...
					$('input[name="pekerjaansi"][value="Tidak"]').removeAttr('checked');
					$('input[name="pekerjaansi"][value="Ya"]').attr('checked', 'checked');
					$('#id_pekerjaansi').combotree().click();
					$('#id_pekerjaansi').combotree('setValue', pemohon.id_pekerjaansi);
					$('#id_pekerjaansi').combotree('enable');


				}

				if (pemohon.id_pekerjaansi == '90000000000010') {
				...
				*/
				...
				if (status_pemohon == 'Tidak') {
					...
					if (penerima.id_pendidikan == '9') {
						$('[name="pendidikan_descb"]').val(penerima.pendidikan_desc);
						$('[name="pendidikan_descb"]').prop({
							disabled: false
						});
					} else {
					...
					$('[name="id_count_unitb"]').val(penerima.id_count_unit).trigger("chosen:updated");
					...
					$('#id_pekerjaanb').combotree().click();

					$('#id_pekerjaanb').combotree('setValue', pemohon.id_pekerjaan).trigger("chosen:updated");
					if (penerima.id_pekerjaan == '90000000000010') {
					...
					if (penerima.pekerjaansi == 'Tidak') {
						...
						$('input[name="pekerjaansib"][value="Tidak"]').removeAttr('checked');
						$('input[name="pekerjaansib"][value="Ya"]').attr('checked', 'checked');
						$('#id_pekerjaansib').combotree().click();
						$('#id_pekerjaansib').combotree('setValue', pemohon.id_pekerjaansi);
						$('#id_pekerjaansib').combotree('enable');

					}

					if (penerima.id_pekerjaansi == '90000000000010') {
	...
	function view(id_permohonan) {
		...
		$.ajax({
			...
			success: function(response) {
				...
				$('#dd_count_unit').append(permohonan.count_unit);

				$('#dd_suku').append(permohonan.suku);
				...
				if (permohonan.id_pekerjaan == '90000000000010') {
				...
				if (permohonan.pekerjaansi == 'Ya') {
					if (permohonan.id_pekerjaansi == '90000000000010') {
				...
				*/
				...
				if (vstatus_pemohon == 'Tidak') {
					...
					$('#dd_count_unitb').append(permohonan.count_unitb);
					...
					if (permohonan.id_pendidikanb == '9') {
						$('#dd_nm_pendidikanb').append(permohonan.pendidikan_descb);
					} else {
					...
					if (permohonan.id_pekerjaanb == '90000000000010') {
					...
					if (permohonan.pekerjaansib == 'Ya') {
						if (permohonan.id_pekerjaansib == '90000000000010') {
