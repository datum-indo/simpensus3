	...
	textarea { resize: vertical; }
			...
			<li class="treeview  active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="<?php echo site_url('tabel/sumber_info'); ?>"><i class="fa fa-circle-o"></i>Sumber Informasi</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Sumber Informasi
            <small>Tabel Data Sumber Informasi Pemohon</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
            <li>Tabel</li>
            <li class="active"><a href="#">Sumber Informasi</a></li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<button id="view_form_add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> Add Sumber Informasi</button>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="Tbl_Sumber_info" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
...
<?php
	include('sumber_info_js.php');
	include('sumber_info_form.php');
	//include('sumber_info_view.php');
	include('footer.php');
?>	