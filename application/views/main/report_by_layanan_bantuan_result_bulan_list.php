            ...
            <div class="col-md-12">
                <div class="box box-default">
                    ...
                    <div class="box-body" id="print_area">
                                  ...
                                  <tbody>
                                      <?php
                                          ...
                                          foreach($report->result_array() as $row)
                                          {
                                            ...
                                            echo '<td class="">'.$row['jkel'].'</td>';
                                            echo '<td class="">'.$row['kondisi_fisik'].'</td>';
                                            echo '<td class="">'.$row['status_approval'].'</td>';
                                            echo '<td class="">'.$row['jenis_kasus'].'</td>';
                                            echo '<td class="">'.$row['issue_ham'].'</td>';
                                            echo '</tr>';

                                            if($row['status_approval'] == 'Diterima')
                                            {
                                                $diterima++;
                                            }
                                            else
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p><strong>Diterima = <?php echo $diterima; ?></strong></p>
                                <p><strong>Ditolak = <?php echo $ditolak; ?></strong></p>
