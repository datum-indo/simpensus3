      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small>Berdasarkan Sifat & Bentuk Kasus</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <div class="row">
                            <?php echo form_open('report/sifat_bentuk_kasus', 'id="thisform" class="" enctype="multipart/form-data"'); ?>
                    ...
                    <div class="box-body" id="print_area">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h4><strong>Berdasarkan Sifat & Bentuk Kasus</strong></h4>
                              ...
                              <table class="table table-bordered">
                                  <thead>
                                      <tr>
                                          ...
                                          <th colspan="2" class="" style="text-align: center;">Sifat Kasus</th>
                                          <th colspan="2" class="" style="text-align: center;">Bentuk Kasus</th>
                                      </tr>  
                                      <tr>
                                          <th class="">Non-Struktural</th>
                                          <th class="">Struktural</th>
                                          <th class="">Individu</th>
                                          <th class="">Kelompok</th>
                                      </tr>
                                  </thead>
                                  <tbody>
                                      <?php
                                          $non_struktural = 0; $struktural = 0; $individu = 0; $kelompok = 0; 
                                          foreach($report->result_array() as $row)
                                          {
                                            echo '<tr>';
                                            echo '<td class="">'.$row['bulan'].'</td>'; 
                                            echo '<td class="tengah">'.$row['non_struktural'].'</td>'; 
                                            echo '<td class="tengah">'.$row['struktural'].'</td>'; 
                                            echo '<td class="tengah">'.$row['individu'].'</td>';
                                            echo '<td class="tengah">'.$row['kelompok'].'</td>';
                                            echo '</tr>';

                                            $non_struktural += $row['non_struktural']; $struktural += $row['struktural']; $individu += $row['individu']; $kelompok += $row['kelompok']; 
                                          }
                                      ?> 
                                  </tbody>
                                  <tfoot>
                                      <tr>
                                          <th class="">Total</th>
                                          <th class=""><?php echo $non_struktural; ?></th>
                                          <th class=""><?php echo $struktural; ?></th>
                                          <th class=""><?php echo $individu; ?></th>
                                          <th class=""><?php echo $kelompok; ?></th>
                                      </tr>
                                  </thead>  
                              </table>
                            </div>
