...
<style>
	textarea { resize: vertical; }
			...
			<li class="treeview active">
              ...
              <ul class="treeview-menu">
				        <li class="active"><a href="<?php echo site_url('setting/account'); ?>"><i class="fa fa-user"></i>Account</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Account
            <small>Data Account Simpensus</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
				  <button id="view_form_add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> Add Account</button>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="Tbl_Account" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Nama Lengkap</th>
