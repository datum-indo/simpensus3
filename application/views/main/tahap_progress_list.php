	...
	textarea { resize: vertical; }
			...
			<li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="<?php echo site_url('tabel/tahap_perkembangan'); ?>"><i class="fa fa-circle-o"></i>Tahap Perkembangan</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Tahap Perkembangan
            <small>Tabel Data Tahap Perkembangan</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
            <li>Tabel</li>
            <li class="active"><a href="#">Tahap Perkembangan</a></li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<button id="view_form_add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> Add Tahap Perkembangan</button>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="Tbl_Tahap_progress" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
...
<?php
	include('tahap_progress_js.php');
	include('tahap_progress_form.php');
	include('footer.php');
?>	