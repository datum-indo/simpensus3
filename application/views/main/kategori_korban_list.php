	...
	textarea { resize: vertical; }
			...
			<li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="<?php echo site_url('tabel/kategori_korban'); ?>"><i class="fa fa-circle-o"></i>Kategori Korban</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Kategori Korban
            <small>Tabel Data Kategori Korban</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i>Home</a></li>
            <li>Tabel</li>
            <li class="active"><a href="#">Kategori Korban</a></li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<button id="view_form_add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> Add Kategori Korban</button>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="Tbl_Kategori_korban" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
                        <th>Kategori Korban</th>
						<th>Nomor Urut</th>
...
<?php
	include('kategori_korban_js.php');
	include('kategori_korban_form.php');
	//include('kategori_korban_view.php');
	include('footer.php');
?>	