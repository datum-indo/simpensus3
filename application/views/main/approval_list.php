	...
	textarea { resize: vertical; }
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="<?php echo site_url('approval'); ?>"><i class="fa fa-circle-o text-red"></i> <span>Approval</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Approval
            <small>Data Persetujuan Bantuan Hukum</small>
          </h1>
          <ol class="breadcrumb">
              ...
              <div class="box">
                <div class="box-header">
                  <?php if($id_role == 1 || $id_role == 2 || $id_role == 3) { ?>
					<button id="view_form_add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> Add Approval</button>
				  <?php } ?>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="Tbl_Approval" class="table table-bordered table-striped dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th>ID</th>
...
<?php
	include('approval_js.php');
	include('approval_form.php');
	include('approval_upload_form.php');
	include('approval_view.php');
	include('footer.php');
?>	